...
class TestRedshiftClient:
    ...
    def test_instance(self):
        return RedshiftClient(
            "test_host", "test_database", "test_user", "test_password"
        )

    def test_connect(self, mock_redshift_conn, test_instance):
        test_instance.connect()
        mock_redshift_conn.assert_called_once_with(
            host="test_host",
    ...
    def test_execute_dataframe_query(self, mock_redshift_conn, test_instance, mocker):
        test_instance.connect()
    ...
    def test_execute_transaction(self, mock_redshift_conn, test_instance, mocker):
        test_instance.connect()
    ...
    def test_execute_transaction_with_many(
        self, mock_redshift_conn, test_instance, mocker
    ):
        test_instance.connect()
    ...
    def test_execute_transaction_with_exception(
        ...
        with pytest.raises(RedshiftClientError):
            test_instance.execute_transaction([("query 1", None), ("query 2", None)])
