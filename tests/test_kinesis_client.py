...
class TestKinesisClient:
    ...
    def test_send_records(self, test_instance, mocker):
        ...
        mocked_send_method = mocker.patch(
            "nypl_py_utils.classes.kinesis_client.KinesisClient._send_kinesis_format_records"
        )  # noqa: E501
        ...
        mocked_send_method.assert_has_calls(
            [
                mocker.call([_TEST_KINESIS_RECORDS[0], _TEST_KINESIS_RECORDS[1]], 1),
                mocker.call([_TEST_KINESIS_RECORDS[2], _TEST_KINESIS_RECORDS[3]], 1),
    ...
    def test_send_kinesis_format_records(self, test_instance):
        test_instance.kinesis_client.put_records.return_value = {"FailedRecordCount": 0}
    ...
    def test_send_kinesis_format_records_with_failures(self, test_instance, mocker):
        ...
        test_instance.kinesis_client.put_records.assert_has_calls(
            [
                ...
                mocker.call(
                    Records=[_TEST_KINESIS_RECORDS[1], _TEST_KINESIS_RECORDS[3]],
