...
class TestConfigHelper:
    ...
    def test_load_env_file(self, mocker):
        ...
        mocker.patch(
            "nypl_py_utils.functions.config_helper.KmsClient",
        ...
        mock_kms_client.decrypt.assert_has_calls(
            [
                mocker.call("test-encryption-1"),
                mocker.call("test-encryption-2"),
                mocker.call("test-encryption-3"),
                mocker.call("test-encryption-4"),
            ]
        )
        ...
        assert (
            os.environ["TEST_ENCRYPTED_LIST"]
